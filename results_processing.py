# author: Jayce Ning
import argparse
from utils import process_data_for_all_tasks, draw_line_box_bar_figure, draw_double_line_box_bar_figure, cal_and_draw_transformation_score, draw_main_result_figure
...
if __name__ == "__main__":
    ...
    if args.result_folder_path is None:
        ...
        if args.task == 'default' or args.task == 'test_prompt_length' or args.task == 'test_nodes_num' or args.task == 'draw_intro_abstract_line_box' or args.task == 'main_result':
