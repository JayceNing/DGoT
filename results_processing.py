# author: Jayce Ning
import argparse
from utils import process_data_for_all_tasks, draw_line_box_bar_figure, draw_double_line_box_bar_figure, cal_and_draw_transformation_score, draw_main_result_figure, draw_node_num_r_i_figure
...
def draw_picture(task, result_folder_path):
    ...
    if task == 'draw_node_num_r_i_figure':
        draw_node_num_r_i_figure(r_1_distribution_dict, r_i_distribution_dict, mean_r_1_list, mean_cost_dict, result_folder_path)
    if task == 'main_result':
        draw_main_result_figure(r_1_distribution_dict, r_i_distribution_dict, mean_r_1_list, mean_cost_dict, result_folder_path)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--task', type=str, default='default', help='0.default, 1.test_prompt_length, 2.test_nodes_num, 3.draw_intro_abstract_line_box, 4.cal_and_draw_transformation_score, 5.main_result, 6.draw_node_num_r_i_figure')
    ...
    if args.result_folder_path is None:
        ...
        if args.task == 'default' or args.task == 'test_prompt_length' or args.task == 'test_nodes_num' or args.task == 'draw_intro_abstract_line_box' or args.task == 'main_result' or args.task == 'draw_node_num_r_i_figure':
