# author: Jayce Ning
import argparse
from utils import process_data_for_all_tasks, draw_line_box_bar_figure, draw_double_line_box_bar_figure
...
if __name__ == "__main__":
    ...
    parser.add_argument('--task', type=str, default='default', help='0.default, 1.test_prompt_length, 2.test_nodes_num, 3.draw_intro_abstract_line_box, 4.cal_transformation_score, 5.cal_introduction_score')
    ...
    if args.result_folder_path is None:
        ...
        elif args.task == 'cal_transformation_score':
            # need update
            pass
